...
void Render::LinesPipeline::create(RTG& rtg, VkRenderPass render_pass, uint32_t subpass) {
	VkShaderModule vert_module = rtg.helpers.create_shader_module(vert_code);
	VkShaderModule frag_module = rtg.helpers.create_shader_module(frag_code);

	{// the set)_camera Layout hold a Camera structure in a uniform buffer use in the vertex shader:
...
void Render::LinesPipeline::destroy(RTG& rtg) {
